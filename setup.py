...
def get_console_scripts() -> list[str]:
    console_scripts = [
        "peftfactory-cli = llamafactory.cli:main",
...
def main():
    setup(
        ...
        version=get_version(),
        author="rbelanec",
        author_email="robert.belanec@kinit.sk",
        description="Unified Parameter-Efficient Fine-Tuning of 100+ LLMs",
        long_description=open("README.md", encoding="utf-8").read(),
        long_description_content_type="text/markdown",
        keywords=["AI", "LLM", "GPT", "ChatGPT", "Llama", "Transformer", "DeepSeek", "Pytorch"],
        license="Apache 2.0 License",
        url="https://github.com/kinit-sk/PEFT-Factory",
        package_dir={"": "src"},
