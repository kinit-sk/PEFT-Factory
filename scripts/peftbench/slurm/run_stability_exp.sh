    ...
    do
        ...
        do
            ...
            do
                ...
                sbatch --job-name ${pm}_${m}_stability_${d}_${s}_${TIMESTAMP} -o logs/${pm}_${m}_stability_${d}_${s}_${TIMESTAMP}.out -e logs/${pm}_${m}_stability_${d}_${s}_${TIMESTAMP}.err scripts/peftbench/slurm/run_train_eval.sh saves_stability/${pm}/${m}/train_${d}_${s}_${TIMESTAMP}/train.yaml saves_stability/${pm}/${m}/eval_${d}_${s}_${TIMESTAMP}/eval.yaml saves_stability/${pm}/${m}/eval_${d}_${s}_${TIMESTAMP} ${d}
