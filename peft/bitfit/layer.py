...
class BitFitLayer(nn.Module, BaseTunerLayer):
    ...
    def merge(self, adapter_names: Optional[list[str]] = None, safe_merge: bool = False):
        ...
        self.base_layer, self.bitfit_layersr[adapter_names[0]] = (
            self.bitfit_layersr[adapter_names[0]],
            self.base_layer,
        )
    ...
    def unmerge(self):
        ...
        self.base_layer, self.bitfit_layersr[merged_name] = (
    ...
    def forward(self, x: torch.Tensor, *args, **kwargs) -> torch.Tensor:
        if self.disable_adapters:
            ...
            result = self.bitfit_layers[active_adapter](x, *args, **kwargs)
